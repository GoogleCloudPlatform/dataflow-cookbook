...
public class TimerDoFn {
    ...
    public static void main(String[] args) throws MalformedURLException {
        TimerDoFnOptions options = PipelineOptionsFactory.fromArgs(args).withValidation().as(TimerDoFnOptions.class);
        ...
        p
                ...
                .apply("Timer", ParDo.of(new DoFn<KV<String, String>, TableRow>() {
                            ...
                            public void onTimer(
                                ...
                                LOG.info("TIMER: Releasing buffer at " + Instant.now().toString()
                                        + " with " + counter.read().toString() + " elements");
                ...
                .apply("WriteInBigQuery", BigQueryIO.writeTableRows().to(options.getTable())
                        .withSchema(schema)
                        .withFailedInsertRetryPolicy(InsertRetryPolicy.neverRetry())  // only available for Streaming
