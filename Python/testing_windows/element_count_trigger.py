...
def get_input_stream():
  stream = (
      ...
      .advance_processing_time(2)
      .add_elements([
          TimestampedValue("Third", timestamp=3)
      ])
      ...
      .add_elements([
          TimestampedValue("Last-In-Window", timestamp=8)
      ])
      ...
      .advance_processing_time(1)
      .add_elements([
          TimestampedValue("Late-6", timestamp=0)
      ])
      .advance_watermark_to(15)
      .advance_processing_time(1)
      .add_elements([
          TimestampedValue("Late-7", timestamp=1)
      ])
...
def run():
  ...
  (p | stream
     ...
     | "Window into FixedWindow with triggering" >> WindowInto(
