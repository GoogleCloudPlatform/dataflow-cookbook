...
def run():
    ...
    BigQuery table. The expected data format follows the standard Google Cloud
    log format, which can be achieved by routing logs to a BigQuery dataset via
    ...
    2. Message Splitting:
        ...
        a. PROCESSED (contain both "severity", "protopayload_auditlog" fields)
    ...
    5. Data Transformation:
        ...
        "protopayload_auditlog" field for PROCESSED messages.

    6. Output Handling:
        - Writes transformed PROCESSED messages to a specified output BigQuery
        table.
        - Sends UNPROCESSED messages to a Dead Letter Queue (DLQ) BigQuery
        table.
    """
