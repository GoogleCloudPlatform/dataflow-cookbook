...
class MyMetricDoFn(DoFn):
    def __init__(self):
        ...
        self.counter_people_in_taxi = Metrics.counter(
            "People", "Delta people in taxi"
        )
    ...
    def process(self, element):
        ...
        if status == "dropoff":
            ...
            self.distribution_cost.update(
                cost * 1000
            )  # Multiplying by 1000 gives more significant decimals
        elif status == "enroute":
