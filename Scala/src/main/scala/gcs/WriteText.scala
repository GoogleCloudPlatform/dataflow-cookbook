...
object WriteText {
  ...
  def main(cmdlineArgs: Array[String]): Unit = {
    ...
    val elements = Seq(
      ...
      "de los de lanza en astillero, adarga antigua, rocin flaco y galgo corredor"
    )


    val create: SCollection[String] = sc.parallelize(elements)

    create
      .saveAsTextFile(output, numShards = 0, suffix = ".txt")
